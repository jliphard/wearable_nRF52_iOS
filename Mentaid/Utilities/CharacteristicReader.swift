...
let FIRST_S_RESERVED_VALUE = ReservedSFloatValues.mder_S_POSITIVE_INFINITY
let FIRST_RESERVED_VALUE   = ReservedFloatValues.mder_POSITIVE_INFINITY
...
struct CharacteristicReader {
    ...
    static func readSFloatValue(ptr aPointer : inout UnsafeMutablePointer<UInt8>) -> Float32 {
        ...
        if mantissa >= FIRST_S_RESERVED_VALUE.rawValue && mantissa <= ReservedSFloatValues.mder_S_NEGATIVE_INFINITY.rawValue {
